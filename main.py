...
from tkinter import  * # For the GUI option

# Computer picks a number
compick = random.randrange(0,25)

# Score and guess variables
guessed = False
score  = 100
guesses = 0
sleep(0.5)

# Function for playing in the terminal
def TerminalGame():
...
# Function for playing in the GUI
def WindowGame():
    pass
...
gametype = input("Would you like to play in the terminal or in a separate window? (t/w) ")
if gametype == "t":
    TerminalGame()
elif gametype == "w":
    WindowGame()
